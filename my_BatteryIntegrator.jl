...
## Saving Figures
if savefigure
    savefig(p1,"~/Documents/Julia/1.Thesis/Battery_FP/Figures/csp_avg_20_$delta_sei0.png")
    savefig(p1,"~/Documents/Julia/1.Thesis/Battery_FP/Figures/csp_avg_20_$delta_sei0.eps")
    savefig(p2,"~/Documents/Julia/1.Thesis/Battery_FP/Figures/I_20_$delta_sei0.png")
    savefig(p2,"~/Documents/Julia/1.Thesis/Battery_FP/Figures/I_20_$delta_sei0.eps")
    savefig(p3,"~/Documents/Julia/1.Thesis/Battery_FP/Figures/delta_sei_20_$delta_sei0.png")
    savefig(p3,"~/Documents/Julia/1.Thesis/Battery_FP/Figures/delta_sei_20_$delta_sei0.eps")
    savefig(p4,"~/Documents/Julia/1.Thesis/Battery_FP/Figures/Q_20_$delta_sei0.png")
    savefig(p4,"~/Documents/Julia/1.Thesis/Battery_FP/Figures/Q_20_$delta_sei0.eps")
end
...
P_1            = NaN*ones(N_plot)
P_1[1:convert(Int64, round(N_plot/2))]     .=  4/150
P_1[convert(Int64, round(N_plot/2)) + 1:end]  .=  -4/150
...
timee = range(0,stop=3600,length=147)

plot(timee, E)
Plots.plot!(sol.t, [sol.u[i][14] for i in 1:N_plot], label = "Q")